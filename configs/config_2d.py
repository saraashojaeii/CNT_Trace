...
parser.add_argument('--dataset_img_path', default = '/home/saraashojaeii/Desktop/CNT_Tracing_DL/DeepBranchTracer_CNT/data/DRIVE/training_data/training_datasets/',help='Train datasets image root path')
parser.add_argument('--dataset_img_test_path', default = '/home/saraashojaeii/Desktop/CNT_Tracing_DL/DeepBranchTracer_CNT/data/DRIVE/training_data/test_datasets/',help='Train datasets label root path')
parser.add_argument('--test_data_path', default = '/home/saraashojaeii/Desktop/CNT_Tracing_DL/DeepBranchTracer_CNT/data/DRIVE/test/images_color/',help='Test datasets root path')
parser.add_argument('--test_data_mask_path', default = '/home/saraashojaeii/Desktop/CNT_Tracing_DL/DeepBranchTracer_CNT/data/DRIVE/temp/mask/',help='Test datasets mask root path')


parser.add_argument('--predict_seed_path', default = '/home/saraashojaeii/Desktop/CNT_Tracing_DL/DeepBranchTracer_CNT/data/DRIVE/temp/frnet_seed/',help='Seed root path')
parser.add_argument('--predict_centerline_path', default = '/home/saraashojaeii/Desktop/CNT_Tracing_DL/DeepBranchTracer_CNT/data/DRIVE/results/pre_centerline_test/',help='Saved centerline result root path')
parser.add_argument('--predict_swc_path', default = '/home/saraashojaeii/Desktop/CNT_Tracing_DL/DeepBranchTracer_CNT/data/DRIVE/results/pre_swc_test/',help='Saved swc result root path')
