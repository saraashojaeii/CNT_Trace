...
def parse_args():
	...
	parser.add_argument('--image_dir', default='/home/saraashojaeii/Desktop/CNT_Tracing_DL/DeepBranchTracer_CNT/data/', help='orginal image saved here')
	
	# (output dir)
	parser.add_argument('--train_dataset_root_dir', default='/home/saraashojaeii/Desktop/CNT_Tracing_DL/DeepBranchTracer_CNT/data/DRIVE/training_data/',help='orginal centerline saved here')
